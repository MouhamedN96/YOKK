        ...
        <div className="flex items-center justify-between mt-4 pt-3 border-t border-border/30">
          <div className="flex items-center gap-2">
            <Avatar className="h-6 w-6">
              ...
              <AvatarFallback className="text-xs bg-secondary">{product.maker.display_name?.[0]}</AvatarFallback>
            </Avatar>
            <span className="text-xs text-muted-foreground">{product.maker.display_name}</span>
          </div>
          <div className="flex items-center gap-2">
